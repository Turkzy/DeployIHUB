...
const HomePanel = () => {
  ...
  const fetchHomes = async () => {
    try {
      const res = await axios.get(
        "https://projectihub-cloud-database.onrender.com/api/home/homes"
      );
      setHomes(res.data);
    } catch (error) {
  ...
  const handleEditHome = async (values) => {
    ...
    try {
      await axios.put(
        `https://projectihub-cloud-database.onrender.com/api/home/update-home-content/${selectedHome._id}`,
        formData,
        {
  ...
  const logAction = async (action, details) => {
    ...
    try {
      await axios.post(
        "https://projectihub-cloud-database.onrender.com/api/logs/create-logs",
        {
          action,
          details,
          user: loggedInUser,
